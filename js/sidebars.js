$(function(){
    // build logos
    var logos = ['eff', 'ala', 'cippic', 'competitive_enterprise', 'demand_progress', 'democrats', 'freepress', 'liberty_coalition', 'open_congress', 'ppf', 'privacy_camp', 'prc', 'reporters_without_borders', 'techdirt'];
    $.each(logos, function(){
        var logo_id = this;
