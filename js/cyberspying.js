$(function(){
  var default_twitter_ids = ['SenatorReid', 'SenatorDurbin'];
  ...
  var update_status = function() {
    ...
    $('.tweet').each(function(){
      ...
      var text = twitter_id+' Does the '+agency+' really need to know '+tweet_body+'? #DefendPrivacy https://cyberspying.eff.org';
      var text_html = twitter_id+' Does the '+agency+' really need to know <strong>'+tweet_body+'</strong>? #DefendPrivacy https://cyberspying.eff.org';
  ...
  function build_tweet_page(reps) {
    ...
    var length = 146 - '.@ Does the  really need to know ? #DefendPrivacy https://cyberspying.eff.org'.length - agency.length - longest_twitter_length; // this is 146 because twitter will shorten the link to 20 chars
